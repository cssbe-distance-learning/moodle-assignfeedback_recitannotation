...
$string['privacy:metadata:azure_ai_api'] = 'Lorsqu\'un point de terminaison IA est configuré par l\'administrateur du site, ce plugin envoie le texte de la remise de l\'élève à ce service externe afin de générer des suggestions d\'annotation. Aucune donnée n\'est transmise si aucun point de terminaison n\'est configuré.';
$string['privacy:metadata:azure_ai_api:submissioncontent'] = 'Le texte de la remise de l\'élève envoyé au service d\'IA externe pour générer des suggestions d\'annotation.';
