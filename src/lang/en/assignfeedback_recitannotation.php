...
$string['privacy:metadata:azure_ai_api'] = 'When an AI endpoint is configured by the site administrator, this plugin sends student submission text to that external service to generate annotation suggestions. No data is transmitted if no endpoint is configured.';
$string['privacy:metadata:azure_ai_api:submissioncontent'] = 'The text of the student\'s submission sent to the external AI service to generate annotation suggestions.';
